...
// const myPostTitle = allPosts.map(function (item) {
//   let postT = item.post;
//   return postT;
// });
...
app.get("/posts/contact", function (req, res) {
  // res.render("contact", {
  //   startingContent: homeStartingContent,
  //   allPosts: allPosts,
  // });
...
app.post("/compose", function (req, res) {
  ...
  // console.log(blogTitle, postMessage);
...
app.get("/posts/:postName", function (req, res) {
  // console.log("Your url is: " + req.params.postName);
  // if (req.params.postName === allPosts[0].title) {
